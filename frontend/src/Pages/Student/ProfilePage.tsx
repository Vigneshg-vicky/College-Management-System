                    ...
                    <div className="extra-details">
                        <div className="flex justify-content-around">
                            <div className="details-1" style={{ height: '3rem', marginLeft: '2.5rem', marginTop: '1rem' }}>
                                ...
                                <span style={{ marginLeft: '2rem', marginTop: '1rem' }}>{data?.student?.gender}</span>
                            </div>
                            ...
                            <div className="details-1" style={{ height: '3rem', marginLeft: '2.5rem', marginTop: '1rem' }}>
                                ...
                                <span style={{ marginLeft: '2rem', marginTop: '1rem' }}>{data?.student?.Joining_Year}</span>
                            </div>
                            <div className="details-1" style={{ height: '3rem', marginLeft: '2.5rem', marginTop: '1rem' }}>
                                <div className="email" style={{ display: 'flex', alignItems: 'center' }}>
                                    <WcIcon style={{ marginLeft: '5px', marginTop: '2px' }} />
                        ...
                        <div className="flex justify-content-around">
                            ...
                            <div className="details-1" style={{ height: '3rem', marginLeft: '2.5rem', marginTop: '1rem' }}>
                                ...
                                <span style={{ marginTop: '1rem' }}>{data?.student.Contact_No}</span>
                            </div>
                            <div className="details-1" style={{ height: '3rem', marginLeft: '2.5rem', marginTop: '1rem' }}>
                                <div className="email" style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <span style={{ marginLeft: '2rem', marginTop: '1rem' }}>{data?.student.email}</span>
                            </div>
                        </div>
                    </div>
